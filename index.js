 ...
 function getData(){
    ...
    const url=`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=dbc147416c29b4423c94aca80198129a` 
 ...
 function getDataLocation (lat,lon){
    const url =`https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid=dbc147416c29b4423c94aca80198129a`;
    fetch(url)
    .then(function(res){
        return res.json();
